import 'package:sahara_app/models/customer_vehicle_model.dart';
...
class CustomerAccountDetailsModel {
  ...
  final List<CustomerVehicleModel> customerVehicles;
  ...
  CustomerAccountDetailsModel({
    ...
    required this.customerVehicles,
  ...
  factory CustomerAccountDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    return CustomerAccountDetailsModel(
      ...
      customerVehicles: (json['customerVehicles'] as List? ?? []).map((v) => CustomerVehicleModel.fromJson(v)).toList(),
