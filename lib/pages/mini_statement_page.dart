    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Center(child: Text(widget.companyName ?? 'SAHARA FCS', style: const TextStyle(fontWeight: FontWeight.bold))),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: ColorsUniversal.buttonsColor),
                    ),
                    SizedBox(height: 8),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: transaction.transactionType == 'Topup' ? ColorsUniversal.fillWids : Colors.grey,
            ...
            Center(child: Text('statement and report the discrepancies')),
