        ...
        if (widget.showSyncButton)
          Padding(
            ...
            child: myButton(context, () async {
              ...
              // Show initial progress dialog - give user feedback
              if (!rootContext.mounted) return;
              await showProgressDialog(rootContext, 'Fetching resources...');
              ...
              try {
                ...
                // Device validation - using hardcoded ID for now
                ...
                // Close progress dialog if something fails
                if (rootContext.mounted) Navigator.pop(rootContext);
